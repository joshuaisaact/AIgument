...
const getProviderApiKey = (provider: 'openai' | 'google' | 'anthropic' | 'xai') => {
...
export type ModelType = 'gpt4o' | 'gpt4' | 'gpt35' | 'claude-sonnet' | 'claude-haiku' | 'gemini-flash' | 'gemini-pro' | 'grok-3' | 'grok-3-mini';
